...
let remoteData = require('electron').remote.getGlobal('mainWindowFunction')

let timerInterval
let timers=[]
let timer

require('electron').ipcRenderer.on('clearTimeData', function (event, data) {
	timers =[]
})
